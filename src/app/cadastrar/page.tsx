...
export default function Signup() {
  return (
    <div className="flex items-center justify-center w-screen min-h-screen bg-gradient-to-r from-orange-300 to-orange-200 py-4 md:py-0">
      <div className="bg-white min-w-[340px] p-6 flex flex-col items-center justify-center rounded-2xl shadow-2xl">
        <LSignup />
        {/* Disable before production */}
        {/* <div className="flex flex-col pb-8 w-full gap-2 md:gap-6 px-10">
